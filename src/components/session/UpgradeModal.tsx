      ...
      >
        <div className="p-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onClose}
              className="px-4 py-2.5 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white rounded-lg font-medium transition-colors"
            >
              Close
            </button>
          </div>
